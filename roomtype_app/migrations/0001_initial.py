    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'indexes': [models.Index(fields=['recordno'], name='roomrecordnoh_idx'), models.Index(fields=['roomcode'], name='roomcodeh_idx'), models.Index(fields=['roomcode', 'roomname'], name='roomcodeh_roonmh_idx')],
            },
        ),
    ]
